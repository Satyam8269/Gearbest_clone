...
function Desc() {
    ...
    useEffect(()=>{
        axios.get(`https://vercel-api-gearbest.vercel.app/products/${id}`)
        .then(res => {
            setdata(res.data)
        })
    ...
    function handleCart(){
        axios.post("https://vercel-api-gearbest.vercel.app/cart",data)
        .then(res=>{
            // console.log(res)
        })
        .catch(err=>{
    ...
    function handleLike(){
        setliked(prev=>!prev)
        axios.post("https://vercel-api-gearbest.vercel.app/wishList",data)
        .then(res=>{
            // console.log(res)
        })
        .catch(err=>{
